...
def fast_gradient(image, epsilon, data_grad):
...
def test(model, opt):
    ...
    for i, (images, labels) in enumerate(test_loader):
        ...
        plot_result("./outputs/fgsm/{}/{}.png".format(opt.data_name, i), images, result, perturbed_images, attack_result)
...
def main():
    ...
    os.makedirs("./outputs/fgsm/{}".format(opt.data_name))
